...
Hello! Thank you for downloading the Retro Pixel Plains tileset. Here are a few pointers to help you navigate and make sense of this zip file.

- There are three tileset styles. In the root folder, you'll see each style has its own folder.
...
- In the style folders, you will also find a folder named spritesheet. This folder contains the spritesheet for that style, and two choices of metadata format for reading the spritesheet. (Pick the format you like!)
...
- Pretty much every object and tile is a size multiple of 8x8 pixels. They're made to stick to an 8x8 grid, but you don't necessarily have to stick to a grid if you don't want to.

- Be sure to check out the included example image to see how to put the tileset together.
